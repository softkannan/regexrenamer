...
public class ShortcutAPI
{
    ...
    internal static extern int SHGetFolderPath(HWND hwndOwner, int nFolder, HWND hToken, int dwFlags, StringBuilder lpszPath);
    ...
    internal interface IShellLinkW
    {
        ...
        void GetIDList(out HWND ppidl);
        /// <summary>Sets the pointer to an item identifier list (PIDL) for a Shell link object.</summary>
        void SetIDList(HWND pidl);
