...
internal class KnownFolderAPI
{
    ...
    internal static extern int SHGetKnownFolderPath( in Guid rfid, SHKF_FLAG dwFlags, HWND hToken, out string ppszPath);

    [DllImport("shfolder.dll", CharSet = CharSet.Auto)]
    internal static extern int SHGetFolderPath(HWND hwndOwner, SHCSIDL csidl, HWND hToken, int dwFlags, StringBuilder lpszPath);
