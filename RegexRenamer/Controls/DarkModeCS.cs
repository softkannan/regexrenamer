...
public class DarkModeCS
{
    ...
    {
        public static bool Light_Theme = true;
    ...
    public DarkModeCS(Form _Form)
    {
        ...
        ThemeName.Light_Theme = !IsDarkMode;
    ...
    private static void ApplySystemDarkTheme(Control control = null)
    {
        ...
        {
            SetWindowTheme(control.Handle,ThemeName.CFD, null);
        }
        else if (control is TextBox)
        {
            ...
            {
                SetWindowTheme(control.Handle,ThemeName.Explorer, null);
            }
            else
            {
                SetWindowTheme(control.Handle,ThemeName.CFD, null);
