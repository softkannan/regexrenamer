...
namespace PInvoke
{
    public static partial class Kernel32
    {
        ...
        public static extern int CompareStringEx(string lpLocaleName, COMPARE_STRING dwCmpFlags, string lpString1, int cchCount1, string lpString2, int cchCount2, [Optional] nint lpVersionInformation, [Optional] nint lpReserved, [Optional] nint lParam);
