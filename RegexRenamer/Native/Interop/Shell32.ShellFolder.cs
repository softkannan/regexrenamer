...
internal class KnownFolderAPI
{
    ...
    internal static extern int SHGetKnownFolderPath( in Guid rfid, SHKF_FLAG dwFlags, IntPtr hToken, out string ppszPath);

    [DllImport("shfolder.dll", CharSet = CharSet.Auto)]
    internal static extern int SHGetFolderPath(IntPtr hwndOwner, SHCSIDL csidl, IntPtr hToken, int dwFlags, StringBuilder lpszPath);

    internal enum SHKF_FLAG : uint
    {
