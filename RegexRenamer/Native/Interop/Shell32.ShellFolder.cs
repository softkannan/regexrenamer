...
namespace PInvoke
{
    ...
    public partial class NativeShell32
    {
        ...
        internal static extern int SHGetKnownFolderPath( in Guid rfid, uint dwFlags, IntPtr hToken, out string ppszPath);

        public enum SHShellSpecialFolderConstants
        {
            DESKTOP          = 0,
            PROGRAMS         = 2,
            CONTROLS         = 3,
        ...
        internal enum SHShellFolder
        {
            Desktop                = ShellSpecialFolderConstants.ssfDESKTOP,
            DesktopDirectory       = ShellSpecialFolderConstants.ssfDESKTOPDIRECTORY,
            MyComputer             = ShellSpecialFolderConstants.ssfDRIVES,
            MyDocuments            = ShellSpecialFolderConstants.ssfPERSONAL,
            MyPictures             = ShellSpecialFolderConstants.ssfMYPICTURES,
            History                = ShellSpecialFolderConstants.ssfHISTORY,
            Favorites              = ShellSpecialFolderConstants.ssfFAVORITES,
            Fonts                  = ShellSpecialFolderConstants.ssfFONTS,
            ControlPanel           = ShellSpecialFolderConstants.ssfCONTROLS,
            TemporaryInternetFiles = ShellSpecialFolderConstants.ssfINTERNETCACHE,
            MyNetworkPlaces        = ShellSpecialFolderConstants.ssfNETHOOD,
            NetworkNeighborhood    = ShellSpecialFolderConstants.ssfNETWORK,
            ProgramFiles           = ShellSpecialFolderConstants.ssfPROGRAMFILES,
            RecentFiles            = ShellSpecialFolderConstants.ssfRECENT,
            StartMenu              = ShellSpecialFolderConstants.ssfSTARTMENU,
            Windows                = ShellSpecialFolderConstants.ssfWINDOWS,
            Printers               = ShellSpecialFolderConstants.ssfPRINTERS,
            RecycleBin             = ShellSpecialFolderConstants.ssfBITBUCKET,
            Cookies                = ShellSpecialFolderConstants.ssfCOOKIES,
            ApplicationData        = ShellSpecialFolderConstants.ssfAPPDATA,
            SendTo                 = ShellSpecialFolderConstants.ssfSENDTO,
            StartUp                = ShellSpecialFolderConstants.ssfSTARTUP
        }
        ...
        /// </summary>
        /// <remarks>Used by <see cref="SHGetFolderPath(IntPtr, SHCSIDL, IntPtr, SHGetFolderPathFlags, char*)"/>.</remarks>
        [Flags]
        internal enum SHConstantSpecialItemIDList
            {
            ...
            /// returned by <see cref                                     ="SHGetFolderLocation(IntPtr, SHCSIDL, IntPtr, int, out ITEMIDLIST*)"/>. This flag has no effect on paths returned by <see cref="SHGetFolderPath(IntPtr, SHCSIDL, IntPtr, SHGetFolderPathFlags, char*)"/>.
            /// </summary>
        ...
        [Flags]
        internal enum SHKnown_Folder_Flag : uint
            {
            /// <summary>
            /// Define no flags.
            /// </summary>
            ...
            /// This flag has no effect on paths returned by <see cref ="SHGetKnownFolderPath(Guid, SHKNOWN_FOLDER_FLAG, IntPtr, out char*)"/> and IKnownFolder::GetPath.
            ...
            /// </summary>
            /// <remarks>This value can be used only with the following functions and methods: <see cref ="SHGetKnownFolderPath(Guid, SHKNOWN_FOLDER_FLAG, IntPtr, out char*)"/>, SHGetKnownFolderIDList, IKnownFolder::GetIDList, IKnownFolder::GetPath, IKnownFolder::GetShellItem</remarks>
        ...
        /// </summary>
        /// <remarks>Used by <see cref="SHGetKnownFolderPath(Guid, SHKNOWN_FOLDER_FLAG, IntPtr, out char*)"/>.</remarks>
