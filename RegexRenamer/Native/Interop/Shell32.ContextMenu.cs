	...
	public class ShellContextMenu : NativeWindow
	{
		...
		private void ShowContextMenu(Point pointScreen)
		{
			...
			try
			{
				...
				uint nSelected = TrackPopupMenuEx( pMenu, TPM.RETURNCMD, pointScreen.X, pointScreen.Y, this.Handle, IntPtr.Zero);
		...
		private interface IShellFolder
		{
			...
			[PreserveSig] Int32 ParseDisplayName( IntPtr hwnd, IntPtr pbc, [MarshalAs(UnmanagedType.LPWStr)] string pszDisplayName, ref uint pchEaten, out IntPtr ppidl, ref SFGAO pdwAttributes);
