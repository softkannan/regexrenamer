...
public partial class TextReplaceForm : Form
{
    ...
    private FindReplace.SearchInfo _interactivePattern = null;
                ...
                case "UpdatePreview":
                    {
                        if (_isInteractiveMode)
                        {
                            ...
                            _interactivePattern = new FindReplace.SearchInfo
                            {
    ...
    private void LstFoundItems_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (selectedItem.Tag is FindReplace.FoundInfo foundItem)
        {
    ...
    private FindReplace.SearchInfo _currentPattern = null;
