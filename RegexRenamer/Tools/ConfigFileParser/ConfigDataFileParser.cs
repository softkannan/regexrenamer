...
namespace ConfigFileParser
{
    ...
    /// </summary>
    public class FileIniDataParser : StreamConfigDataParser
    {
        /// <summary>
        ///     Represents an INI data parser for files.
        /// </summary>
        ...
        public FileIniDataParser(ConfigDataParser parser) : base(parser)
        {
            Parser = parser;
        }
        ...
        public ConfigData LoadFile(string filePath)
        {
            return ReadFile(filePath);
        }

        public ConfigData LoadFile(string filePath, Encoding fileEncoding)
        {
        ...
        ///     Path to the file
        /// </param>
        public ConfigData ReadFile(string filePath)
        {
        ...
        ///     File's encoding.
        /// </param>
        public ConfigData ReadFile(string filePath, Encoding fileEncoding)
        {
            ...
            {
               throw new InvalidOperationException(String.Format("Could not parse file {0}", filePath), ex);
            }
        ...
        /// </param>
        public void SaveFile(string filePath, ConfigData parsedData)
        {
        ...
        /// </param>
        public void WriteFile(string filePath, ConfigData parsedData, Encoding fileEncoding = null)
        {
