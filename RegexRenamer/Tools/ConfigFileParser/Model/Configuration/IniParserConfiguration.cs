...
namespace ConfigFileParser.Model.Configuration
{
    ...
    public class IniParserConfiguration : ICloneable
    {
        ...
        /// <summary>
        ///     Default values used if an instance of <see cref="ConfigDataParser"/>
        ...
        ///     the <see cref="ConfigDataParser"/> will stop with an error.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        ///     If set to <c>false</c> and the <see cref="ConfigDataParser"/> finds duplicate keys in a
        ...
        /// <summary>
        ///     If <c>true</c> the <see cref="ConfigDataParser"/> instance will thrown an exception
        ...
        /// <summary>
        ///     If set to <c>false</c> and the <see cref="ConfigDataParser"/> finds a duplicate section
        ///     the parser will stop with an error.
        ///     If set to <c>true</c>, duplicated sections are allowed in the file, but only a
        ///     <see cref="SectionData"/> element will be created in the <see cref="ConfigData.Sections"/>
        ///     collection.
        /// </summary>
        /// <remarks>
        ///     Defaults to <c>false</c>.
        ...
        /// <summary>
        ///     If set to <c>false</c>, the <see cref="ConfigDataParser"/> stop with a error if you try
