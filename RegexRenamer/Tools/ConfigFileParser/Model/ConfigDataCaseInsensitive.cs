...
{
    /// <summary>
    ///     Represents all data from an INI file exactly as the <see cref="ConfigData"/>
    ///     class, but searching for sections and keys names is done with
    ///     a case insensitive search.
    /// </summary>
    public class ConfigDataCaseInsensitive : ConfigData
    {
        /// <summary>
        ///     Initializes an empty IniData instance.
        /// </summary>
        public ConfigDataCaseInsensitive()
        ...
        /// </param>
        public ConfigDataCaseInsensitive(SectionDataCollection sdc)
        ...
        public ConfigDataCaseInsensitive(ConfigData ori)
