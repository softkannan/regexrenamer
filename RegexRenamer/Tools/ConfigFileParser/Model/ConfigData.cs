...
namespace ConfigFileParser.Model
{
    /// <summary>
    ...
    public class ConfigData : ICloneable
    {
        ...
        /// </param>
        public ConfigData(SectionDataCollection sdc)
        {
        ...
        public ConfigData(ConfigData ori): this((SectionDataCollection)ori.Sections)
        {
        ...
        /// </summary>
        /// <remarks>
        ///     If the <see cref="ConfigData"/> instance was created by a parser,
        ...
        ///     when using <see cref="ConfigData.TryGetKey"/>. 
        /// </summary>
        /// <remarks>
        ///     Defaults to '.'.
        /// </remarks>
        ...
        public virtual string ToString(IniDataFormatter formatter)
        {
        ...
        /// </param>
        public void Merge(ConfigData toMergeIniData)
        {
        ...
        /// </summary>
        /// <param name="key">
        ///     The section and key name to retrieve, separated by <see cref="ConfigData.SectionKeySeparator"/>.
        /// 
